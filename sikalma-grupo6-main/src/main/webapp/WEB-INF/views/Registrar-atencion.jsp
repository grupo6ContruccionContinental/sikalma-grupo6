    ...
    <main>
        ...
        <div class="cita-origen">
            ...
            <div class="cita-origen-datos">
                ...
                <span><strong>Estado de cita:</strong>
                    <span class="badge badge-confirmado">${cita.estado}</span>
                </span>
            </div>
        </div>
            ...
            <form action="/atencion/nuevo" method="post">
                ...
                <div class="fila-form">
                    <div>
                        ...
                        <input type="text" value="${cita.paciente.nombres}" readonly
                               style="background-color:#f5f0f0; color:#9a8a88;">
                    </div>
                    <div>
                        <label>Doctor que atiende</label>
                        <input type="text" value="${cita.doctor.nombre}" readonly
                               style="background-color:#f5f0f0; color:#9a8a88;">
                    </div>
                </div>
                ...
                <div class="fila-form">
                    <div>
                        ...
                        <input type="text" value="${cita.servicio.nombre}" readonly
                               style="background-color:#f5f0f0; color:#9a8a88;">
                    </div>
                    <div>
                        <label>Fecha de atención</label>
                        <input type="date" value="${cita.fecha}" readonly
                               style="background-color:#f5f0f0; color:#9a8a88;">
                    </div>
                </div>
